...
export default async function AddCandidatePage() {
  ...
  async function createCandidateFormAction(formData: FormData) {
    "use server";
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <div className="mt-6 space-y-3">
        <p className="text-sm uppercase tracking-[0.3em] text-coral">New Candidate</p>
        <h1 className="font-[var(--font-heading)] text-4xl text-ink">Add a candidate profile</h1>
      </div>
      <div className="mt-8">
